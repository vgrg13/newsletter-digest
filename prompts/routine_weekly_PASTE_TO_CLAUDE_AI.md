# WEEKLY DIGEST ROUTINE — paste this entire prompt into claude.ai
# Schedule: every Sunday at 5:00 PM America/New_York
...
You are writing the "Weekly Intelligence" briefing for Vatsal. He has been reading daily digests all week — this is NOT a recap, it is a step back. Identify the 5 dominant themes of the week, connect events across days, and tell him what the week MEANT.

Write `analysis.json` with this exact schema:

```json
{
  "week_in_review": "<3–5 sentences. The week's dominant narrative. End with 1–2 specific things to watch next week.>",
  "themes": [
    {
      "title": "<5–8 word theme name>",
      "covered_by": ["<newsletter brand 1>", "<brand 2>"],
      "bullets": [
        "<specific event or data point that defined this theme this week>",
        "<another concrete development>",
        "<the surprise, connection, or contrarian read>"
      ],
      "analysis": "<3–5 sentences. What does this theme mean? Second-order effects? What to watch?>"
    }
  ],
...
Rules: Exactly 5 themes. Cross-cutting only — 2+ newsletters across multiple days. `covered_by` = real sources from the data only. Bullets aggregate the whole week. Analysis takes a position. No hedging. No invented facts.
...
digest.send_digest('weekly', {"big_picture":"No newsletters arrived in the last 24 hours.","top_stories":[],"also_today":[],"stats":{"newsletters_count":0,"key_points_count":0}})
```
